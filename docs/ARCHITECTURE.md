...
| Internal Support Platform | `InternalSupportPlatformPanel.jsx` | Tools tab `internal_support`; LifeBuoy; Floor hidden for Food/Asset/Biometric/Lost belongings unless mixed with a location issue; Comment after floor when Floor shows (local); not Enquiry |
