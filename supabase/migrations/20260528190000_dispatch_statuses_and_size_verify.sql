-- Dispatch: hidden statuses (dispatch_fail, dispatched), per-size verification json.
...
begin
  ...
  if actor_role = 'viewer' then
    ...
    -- Dispatch tab: verification fields; status may become dispatch_fail or dispatched only.
