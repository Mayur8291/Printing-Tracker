...
export const INVENTORY_SKU_LIST_SELECT =
  "id, sku_code, kind, name, color, hex_color, stock_qty, reorder_point, doc, drr, unit, unit_cost, retail_price, supplier_id, warehouse_id, bin_location, last_received_at, tags, extra, parent_style_id, inventory_style_parents(id, parent_sku_code, style_name)";
