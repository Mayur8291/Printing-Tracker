...
import { jobSheetPaymentModeLabel } from "./jobSheetPaymentUtils";
...
import { isSamplingOrder, isStickerOrder } from "./stickerOrderUtils";
                ...
                {visibleOrders.map((order) => {
                  ...
                  return (
                    <TableRow key={order.id} className={orderListRowClassName(order)}>
                      ...
                      <TableCell>
                        {isJobSheetOrder(order)
                          ? jobSheetPaymentModeLabel(order.job_sheet_payment_mode)
