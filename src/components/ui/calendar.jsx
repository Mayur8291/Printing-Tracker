  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_root: cn(
          "relative inline-flex h-8 items-center rounded-md border border-input shadow-xs has-[:focus]:border-ring has-[:focus]:ring-[3px] has-[:focus]:ring-ring/50",
        ...
        weekday: cn(
          "text-muted-foreground size-8 select-none text-[0.8rem] font-normal",
        ...
        day: cn(
          "group/day relative flex size-8 items-center justify-center p-0 text-center",
...
function CalendarDayButton({ className, day, modifiers, ...props }) {
  ...
  return (
    <Button
      ...
      className={cn(
        "flex h-8 w-8 items-center justify-center rounded-md p-0 font-normal leading-none transition-colors",
